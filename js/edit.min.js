...
$('#addInput').click(function() {
	...
	$("#links").append("<tr><td><input type='text' id='inputtitlelink-" + nb + "' name='inputtitlelink[" + nb + "]' class='link-title field' rows='1' placeholder='...' value='' /></td><td><input type='text' id='inputurllink-" + nb + "' name='inputurllink[" + nb + "]' class='link-url field' rows='1' placeholder='https://...' value='' /></td></tr>");
});